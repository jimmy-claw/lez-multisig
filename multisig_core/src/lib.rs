...
// PDA compute helpers have been moved to lez-multisig-ffi/src/multisig.rs (generated by spel-client-gen).
//
...
/// Uses SHA-256(pad32("multisig_vault__") || create_key) — matches spel-cli multi-seed derivation.
/// This allows `spel-cli pda vault --create-key <key>` to work without any special tooling.
pub fn vault_pda_seed(create_key: &[u8; 32]) -> PdaSeed {
    // Matches spel-cli pda.rs hash_seeds: SHA-256(seed1_32bytes || seed2_32bytes)
